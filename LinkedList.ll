...
define i1 @Element.Equal(i8* %this, i8* %.other) {
	...
	br i1 %_45, label %if_then_3, label %if_else_3
...
define i8* @List.Delete(i8* %this, i8* %.e) {
	...
	%_20 = call i1 %_18(i8* %_13, i8* %_19)

	br i1 %_20, label %if_then_7, label %if_else_7
	...
	br i1 %_22, label %if_then_8, label %if_else_8
	...
	if_then_8:
	%_39 = load i8*, i8** %aux01
	%_40 = bitcast i8* %_39 to i8***
	%_41 = load i8**, i8*** %_40
	%_42 = getelementptr i8*, i8** %_41, i32 8
	%_43 = load i8*, i8** %_42
	%_44 = bitcast i8* %_43 to i8* (i8*)*
	%_45 = call i8* %_44(i8* %_39)

	store i8* %_45, i8** %my_head
	...
	%_46 = load i1, i1* %ret_val
	%_47 = xor i1 %_46, 1
	br i1 %_47, label %if_then_9, label %if_else_9
...
define i32 @List.Search(i8* %this, i8* %.e) {
	...
	%_7 = xor i1 %_6, 1
	br i1 %_7, label %loop_enter_1, label %loop_exit_1
	...
	%_16 = call i1 %_14(i8* %_9, i8* %_15)

	br i1 %_16, label %if_then_10, label %if_else_10
	...
	%_25 = bitcast i8* %_24 to i8***
	%_26 = load i8**, i8*** %_25
	%_27 = getelementptr i8*, i8** %_26, i32 6
	%_28 = load i8*, i8** %_27
	%_29 = bitcast i8* %_28 to i1 (i8*)*
	%_30 = call i1 %_29(i8* %_24)

	store i1 %_30, i1* %var_end
	...
	store i8* %_37, i8** %var_elem

	br label %loop_check_1

	loop_exit_1:

	%_38 = load i32, i32* %int_ret_val
	ret i32 %_38
}
...
define i1 @List.Print(i8* %this) {
	...
	%_6 = load i1, i1* %var_end
	%_7 = xor i1 %_6, 1
	br i1 %_7, label %loop_enter_2, label %loop_exit_2

	loop_enter_2:
	%_9 = load i8*, i8** %var_elem
	%_10 = bitcast i8* %_9 to i8***
	%_11 = load i8**, i8*** %_10
